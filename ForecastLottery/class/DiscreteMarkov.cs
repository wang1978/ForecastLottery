...
public class DiscreteMarkov
{
    ...
    public DiscreteMarkov(List<int> data, int count, int K = 5)
    {
        ...
        var t0 = DenseMatrix.OfArray(ConvertToArray<double>(StaticProbability(this.CountStatic)));
        ProbMatrix.Add(t0);
    ...
    public int[][] StaticCount(List<int> data, int statusCount)
    {
    ...
    public double[][] StaticProbability(int[][] data)
    {
    ...
    /// <returns></returns>
    public static T[,] ConvertToArray<T>(T[][] data)
    {
